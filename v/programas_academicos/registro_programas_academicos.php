			...
			<div class="form-group">
				<div class="row">
					<div class="col-sm-4">
						...
						<div class="col-sm-4">
							<label for="key"><span class="text-danger">* </span>Clave</label>
							<input type="number" class="form-control"  id="key" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
						</div>
