                    ...
                    <ul class="nav sidebar-nav">
                        <div class="sidebar-header">
                            <div class="sidebar-brand">
                                <span class="align:left" style="color: white; font-weight: bold; font-size: 20px;">Actualizar alumnos</span>
                            </div>
                        </div>
...
<div class="container mt-5">
		<div id="new" style="text-align: center;"><br><br>
			<div style="text-align: center; border-bottom: 3px solid #cecece; margin-bottom: 30px;">
				<h3>Actualizar registro de un alumno</h3>				
			</div>	
			<br>
				...
				<div class="form-group">
					<div class="row">						
						<div class="col-sm-4">
							...
							<select name="program" id="program" class="form-control" onchange="getCourses();">
...
<br><br>
   ...
   <script src="../../assets/js/sidebar.js"></script>
	...
	<script src="../../controllers/alumnos/script_actualizar_alumnos.js"></script>
	<script>
		getStudent();
		coursesAds();
