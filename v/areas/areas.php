...
<nav class="navbar navbar-expand-lg navbar-light bg-nav">
                    ...
                    <ul class="nav sidebar-nav">
                        <div class="sidebar-header">
                            <div class="sidebar-brand">
                                <span class="align:left" style="color: white; font-weight: bold; font-size: 20px;">Áreas</span>
                            </div>
                        </div>
	...
	<div class="container mt-5">
		...
		<span style="color: black; font-weight: bold; font-size: 16px; align:left; ">ÁREAS REGISTRADAS</span><br>
		<br><br>
  			<div style="text-align: center; border-bottom: 3px solid #cecece; margin-bottom: 30px; margin-top: 30px">
				<nav class="navbar navbar-light ">
				  ...
				  <button type='button' class='btn btn-outline-success'  id='btn-new-area' onClick='redirigirNewArea()'>NUEVA ÁREA</button>
				</nav>
		    </div>
