...
<head>
	<meta charset="UTF-8">
	<title>Liberación de área</title>
                    ...
                    <ul class="nav sidebar-nav">
                        <div class="sidebar-header">
                            <div class="sidebar-brand">
                                <span class="align:left" style="color: white; font-weight: bold; font-size: 20px;">Liberacion de áreas</span>
                            </div>
                        </div>
...
<div class="container mt-5">
        ...
        <div style="text-align: center; border-bottom: 3px solid #cecece; margin-bottom: 30px; margin-top: 30px">
            <nav class="navbar navbar-light ">
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <a class="nav-item nav-link active" id="nav-inProgress-tab" data-toggle="tab" href="#nav-inProgress" role="tab" aria-controls="nav-inProgress" aria-selected="false">
   ...
   <script src="../../assets/js/sidebar.js"></script>
	...
	<script src="../../controllers/liberacion_area/script_liberacion_area.js"></script>
</body>
</html>
<?php
 ?>
