                    ...
                    <ul class="nav sidebar-nav">
                        <div class="sidebar-header">
                            <div class="sidebar-brand">
                                <span class="align:left" style="color: white; font-weight: bold; font-size: 20px;">Registro de usuarios</span>
                            </div>
                        </div>
		...
		<div id="new" style="text-align: center;"><br><br>
			...
			<div class="form-group">
				...
				<div class="form-group" align="center">
					...
					<button type="button" class="btn btn-success-guardar w-20" id="save-exam" onclick="saveUser();">Guardar</button>
				</div>				
			</div>	
		</div>		
	</div>
