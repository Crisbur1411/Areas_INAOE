...
<nav class="navbar navbar-expand-lg navbar-light bg-nav">
	...
	<div class="container mt-5">
		...
		<span style="color: black; font-weight: bold; font-size: 16px; align:left; ">TIPOS DE USUARIO REGISTRADOS</span><br>
		<br><br>
  			<div style="text-align: center; border-bottom: 3px solid #cecece; margin-bottom: 30px; margin-top: 30px">
				<nav class="navbar navbar-light ">
				  ...
				  <button type='button' class='btn btn-outline-success'  id='btn-new-area' onClick='newTypeUser()'>NUEVO TIPO</button>
				</nav>
		    </div>

			<div class="tab-content" id="nav-tabContent">
  				<div class="tab-pane fade show active" id="nav-type-users" role="tabpanel" aria-labelledby="nav-type-users-tab">
				  <div class="tab-pane fade show active" id="nav-type-users" role="tabpanel" aria-labelledby="nav-type-users-tab">
