...
<nav class="navbar navbar-expand-lg navbar-light bg-nav">
                    ...
                    <ul class="nav sidebar-nav">
                        <div class="sidebar-header">
                            <div class="sidebar-brand">
                                <span class="align:left" style="color: white; font-weight: bold; font-size: 20px;">Empleados</span>
                            </div>
                        </div>
    ...
    <nav class="navbarINAOE">
        <div class="container-fluid">
            ...
            <div class="seccionesEstatus">
                <li><a>Empleados registrados</a></li>
            </div>
            </div>
        </div>
    </nav>
	...
	<div class="container mt-5">
		...
		<span style="color: black; font-weight: bold; font-size: 16px; align:left; ">EMPLEADOS RESPONSABLES DE PRÉSTAMOS</span><br>
		<br><br>
  			<div style="text-align: center; border-bottom: 3px solid #cecece; margin-bottom: 30px; margin-top: 30px">
				<nav class="navbar navbar-light ">
  				<div class="nav nav-tabs" id="nav-tab" role="tablist">
    				<a class="nav-item nav-link active" id="nav-employees-tab" data-toggle="tab" href="#nav-employees" role="tab" aria-controls="nav-toSign" aria-selected="true">
						Registros en sistema <span id="pf" class="badge badge-info">0</span>
  						<span class="sr-only">unread messages</span>
					</a>									
  				</div> 
				  <button type='button' class='btn btn-outline-success'  id='btn-new-user' onClick='newEmployee()'>NUEVO EMPLEADO</button>
				</nav>
		    </div>
					...
					<table class="table table-striped table-bordered">
						<thead style="background: #691C32; color: white;">
							<tr>
								...
								<th scope="col" style="text-align:center">NOMBRE DEL EMPLEADO</th>
								<th scope="col" style="text-align:center">ÁREA</th>
								<th scope="col" style="text-align:center">TIPO DE USUARIO</th>
                                <th scope="col" style="text-align:center">EMAIL</th>
								<th scope="col" style="text-align:center">ACTUALIZAR EMPLEADO</th>
								<th scope="col" style="text-align:center">ELIMINAR EMPLEADO</th>
							</tr>
						</thead>
						<tbody class="bg-white" id="table-employees"></tbody>
					</table>
	              </div>  
