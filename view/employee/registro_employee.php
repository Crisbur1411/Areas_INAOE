                    ...
                    <ul class="nav sidebar-nav">
                        <div class="sidebar-header">
                            <div class="sidebar-brand">
                                <span class="align:left" style="color: white; font-weight: bold; font-size: 20px;">Registro de empleados</span>
                            </div>
                        </div>
		...
		<div id="new" style="text-align: center;"><br><br>
			...
			<div class="form-group">
				...
				<div class="form-group" align="center">
					...
					<button class="btn btnConfirm btn-lg active" type="button" id="save-exam" onclick="saveEmployee();">Guardar</button>
				</div>				
			</div>	
		</div>		
	</div>
