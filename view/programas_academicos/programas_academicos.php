...
<nav class="navbar navbar-expand-lg navbar-light bg-nav">
                ...
                <nav class="navbar navbar-inverse fixed-top" id="sidebar-wrapper" role="navigation">
                    <ul class="nav sidebar-nav">
                        ...
                        <?php if ($_SESSION['type'] == 0 ): ?>	
							...
							<li><a class="dropdown-item" href="#">Programas académicos</a> </li>							
							<?php endif; ?>
                            <?php if ($_SESSION['type'] == 1 || $_SESSION['type'] == 2): ?>
    ...
    <nav class="navbarINAOE">
        <div class="container-fluid">
            ...
            <div class="seccionesEstatus">
                <li><a>Programas académicos</a></li>
            </div>
            </div>
        </div>
    </nav>
    ...
    <div id="info" class="d-none" style="text-align: center;"> 
        <span style="color: black; font-weight: bold; font-size: 16px; align:left;">PROGRAMAS ACADÉMICOS REGISTRADOS</span><br>
        <br><br>
        <div style="text-align: center; border-bottom: 3px solid #cecece; margin-bottom: 30px; margin-top: 30px">
            <nav class="navbar navbar-light">
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <a class="nav-item nav-link active" id="nav-programs-tab" data-toggle="tab" href="#nav-programs" role="tab" aria-controls="nav-programs" aria-selected="true">
                        Registros en sistema <span id="pf" class="badge badge-info">0</span>
                        <span class="sr-only">unread messages</span>
                    </a>									
                </div> 
                <button type='button' class='btn btn-outline-success' id='btn-new-program' onClick='newProgram()'>NUEVO PROGRAMA</button>
            </nav>
        </div>

        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-programs" role="tabpanel" aria-labelledby="nav-programs-tab">
                <table class="table table-striped table-bordered">
                    <thead style="background: #691C32; color: white;">
                        <tr>
                            ...
                            <th scope="col" style="text-align:center">TIPO DE PROGRAMA</th>
                            <th scope="col" style="text-align:center">ACTUALIZAR PROGRAMA</th>
                            <th scope="col" style="text-align:center">ELIMINAR PROGRAMA</th>
                        </tr>
                    </thead>
                    <tbody class="bg-white" id="table-programs"></tbody>
                </table>
