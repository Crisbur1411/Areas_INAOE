                    ...
                    <ul class="nav sidebar-nav">
                        <div class="sidebar-header">
                            <div class="sidebar-brand">
                                <span class="align:left" style="color: white; font-weight: bold; font-size: 20px;">Tipo de usuarios</span>
                            </div>
                        </div>
    ...
    <div id="new" style="text-align: center;"><br><br>
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <label for="searchStudentEdit">Buscar Estudiante</label>
                    <input type="text" class="form-control mb-2" id="searchStudentEdit" placeholder="Buscar estudiante..." style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
        ...
        <div class="form-group" align="center">
            ...
            <button class="btn btnConfirm btn-lg active" type="button" id="save-exam" onclick="savePrestamoEdit();">Guardar</button>
        </div>
    </div>
</div>
