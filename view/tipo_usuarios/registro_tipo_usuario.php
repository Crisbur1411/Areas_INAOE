...
<head>
	<meta charset="UTF-8">
	<title>Registro de tipos de usuario</title>
    ...
    <nav class="navbarINAOE">
        <div class="container-fluid">
            ...
            <div class="seccionesEstatus">
                <li><a>Nuevo tipo de usuario</a></li>
            </div>
            </div>
        </div>
    </nav>
	...
	<div class="container mt-5">
		<div id="new" style="text-align: center;"><br><br>
			<div style="text-align: center; border-bottom: 3px solid #cecece; margin-bottom: 30px;">
				<h3>Registro de un nuevo tipo de usuario</h3>				
			</div>	
			<br>
			<div class="form-group">
				...
				<div class="form-group" align="center">
					...
					<button class="btn btnConfirm btn-lg active" type="button" id="save-exam" onclick="saveTypeUser();">Guardar</button>
				</div>				
			</div>	
		</div>		
	</div>
