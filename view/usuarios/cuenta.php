			...
			<div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="modalEditarLabel" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						...
						<button class="btn btnCancel btn-lg active" type="button"  data-dismiss="modal">Cerrar</button>
						<button class="btn btnConfirm btn-lg active" type="button" id="save-exam"  onclick="saveChanges(<?php echo $_SESSION['id_user']; ?>)">Guardar</button>
						</div>
					</div>
				</div>
			</div>
