                ...
                <nav class="navbar navbar-inverse fixed-top" id="sidebar-wrapper" role="navigation">
                    <ul class="nav sidebar-nav">
                        <div class="sidebar-header">
                            <div class="sidebar-brand">
                                <span class="align:left"
                                    style="color: white; font-weight: bold; font-size: 20px;">Gestión de Procesos</span>
                            </div>
                        </div>
                        ...
                        <?php if ($_SESSION['type'] == 1 || $_SESSION['type'] == 2): ?>
                            <li><a class="dropdown-item" href="../programas_academicos/programas_academicos.php">Programas
                                    académicos</a> </li>
                        <?php endif; ?>
                        <?php if ($_SESSION['type'] == 1 || $_SESSION['type'] == 2): ?>
                        ...
                        <?php if ($_SESSION['type'] == 1): ?>
                            <li><a class="dropdown-item" href="../tipo_usuarios/tipo_usuarios.php">Tipo de usuarios</a>
                            </li>
                        <?php endif; ?>
                        <?php if ($_SESSION['type'] == 1 || $_SESSION['type'] == 2): ?>
                        ...
                        <?php if ($_SESSION['type'] == 3): ?>
                            <li><a class="dropdown-item" href="../liberacion_area/liberacion_area.php">Liberación del
                                    área</a></li>
                        <?php endif; ?>
        ...
        <div class="container-fluid">
            <div class="contNav">
                ...
                <div class="secciones">
                    ...
                    <a href="https://www.gob.mx/busqueda"><span class="sr-only">Búsqueda</span><i class="fa fa-search"
        ...
        <div class="container-fluid">
            <div class="contNav">
                <div class="seccionesINAOE">
                    <li>
                        <p class="text_inaoe">INAOE</p>
                    </li>
                </div>

                <div class="seccionesEstatus">
                    <li><a>Gestión de Procesos</a></li>
                </div>
            </div>
        </div>
    </nav>
