	...
	<div class="container mt-5">
		<div id="new" style="text-align: center;"><br><br>
			<div style="text-align: center; border-bottom: 3px solid #cecece; margin-bottom: 30px;">
				<h3>Registro de un Nuevo Paso para el Proceso</h3>				
			</div>	
			<br>
			<div class="form-group">
				...
				<div class="form-group" align="center">
					...
					<button class="btn btnConfirm btn-lg active" type="button" id="save-exam" onclick="saveProcess();">Guardar</button>
				</div>				
			</div>	
		</div>		
	</div>
